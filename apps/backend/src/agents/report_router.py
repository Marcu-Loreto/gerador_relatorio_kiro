...
def get_report_agent(report_type: str):
    ...
    from src.agents.requirements_analysis import RequirementsAnalysisAgent
    ...
    agents = {
        ...
        ReportType.REQUIREMENTS_ANALYSIS: RequirementsAnalysisAgent,
        # string fallbacks
        ...
        "requirements_analysis": RequirementsAnalysisAgent,
    }
