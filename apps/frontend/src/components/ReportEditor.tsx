    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {(viewMode === "edit" || viewMode === "split") && (
          <div
            className={`flex-1 flex flex-col ${viewMode === "split" ? `border-r ${border}` : ""}`}
          >
            <div
              className={`px-3 py-1.5 text-xs font-medium border-b ${border} ${darkMode ? "text-gray-400 bg-gray-800" : "text-gray-500 bg-gray-50"}`}
            >
